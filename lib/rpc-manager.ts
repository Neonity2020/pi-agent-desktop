...
class PlainTextTheme extends Theme {
  constructor() {
    super(
      // Pi 0.84 derives searchMatchText/scrollbarThumb from sibling fields
      // during construction, even though this headless theme overrides every
      // color operation.
      { thinkingXhigh: "", text: "", searchMatchText: "" } as ConstructorParameters<typeof Theme>[0],
