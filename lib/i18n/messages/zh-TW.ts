...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "files.expandPanel": "展開為全寬面板",
    "files.restorePanelWidth": "恢復面板寬度",
    ...
    "sidebar.rename": "重新命名",
    "sidebar.delete": "刪除",
    "sidebar.renameFailed": "重新命名失敗：{error}",
    "sidebar.deleteFailed": "刪除失敗：{error}",
    ...
    "chat.compactingRetry": "正在壓縮…（重試 {attempt}/{max}）",
    "chat.cancelRetry": "取消重試",
    "chat.toolCancelled": "已取消",
    "chat.sessionAutomation": "會話自動化",
    "chat.autoCompaction": "上下文寫滿時自動壓縮",
    "chat.autoRetry": "供應商出錯時自動重試",
    "chat.steeringMode": "引導訊息投遞方式",
    "chat.followUpMode": "後續訊息投遞方式",
    "chat.queueMode.all": "全部投遞",
    "chat.queueMode.one-at-a-time": "逐條投遞",
    "chat.compact": "壓縮",
    ...
    "layout.resizeFileTree": "調整專案樹寬度",
    "sidebar.filterFiles": "篩選檔案…",
    "sidebar.switchBranch": "切換分支",
    "sidebar.switchBranchTitle": "在當前檢出中切換到 {branch}",
    "sidebar.fetchBranchesTitle": "從遠端拉取分支",
    "sidebar.branchRemoteTitle": "遠端分支——檢出後會建立本地跟蹤分支",
    "sidebar.branchInWorktreeTitle": "{branch} 已在其他 worktree 檢出，點選切換過去",
    "sidebar.remoteBranchTag": "遠端",
    "sidebar.noOtherBranches": "沒有其他分支",
    "sidebar.projects": "專案",
    "sidebar.showMoreSessions": "展開顯示",
    "sidebar.showLessSessions": "收起顯示",
    "sidebar.expandProjects": "顯示所有專案",
    "sidebar.collapseProjects": "收起專案",
    "sidebar.noOtherProjects": "暫無其他專案",
    "sidebar.projectChatsCount": "{count} 個會話",
    ...
    "contextPanel.tabOpen": "開啟",
    "contextPanel.tabFiles": "檔案",
    "contextPanel.tabSearch": "搜尋",
    "contextPanel.tabBrowser": "瀏覽器",
    "contextPanel.tabDiff": "Diff",
    "contextPanel.tabReview": "審查",
    "contextPanel.newPanel": "新建面板",
    "contextPanel.fileActions": "檔案操作",
    "contextPanel.copyPath": "複製路徑",
    "contextPanel.copyContents": "複製檔案內容",
    "contextPanel.wordWrap": "啟用自動換行",
    "contextPanel.hideFileList": "隱藏檔案列表",
    "contextPanel.showFileList": "顯示檔案列表",
    "contextPanel.terminalUnavailable": "當前版本暫不支援終端",
    "contextPanel.toggleTitle": "檔案",
    "contextPanel.toggleLabel": "切換檔案面板",
    "contextPanel.browser": "瀏覽器",
    "contextPanel.browserAddress": "瀏覽器地址",
    "contextPanel.browserPlaceholder": "輸入網址…",
    "contextPanel.browserGo": "Go",
    "contextPanel.browserBack": "後退",
    "contextPanel.browserForward": "前進",
    "contextPanel.browserReload": "重新整理",
    "contextPanel.browserOpenExternal": "在系統瀏覽器中開啟",
    "contextPanel.browserEmpty": "開啟網頁",
    "contextPanel.browserHint": "在上方輸入網址，即可在右側欄中瀏覽。",
    "contextPanel.diffHint": "檢視當前專案的變更",
    "contextPanel.diffRefresh": "重新整理變更",
    "contextPanel.diffEmpty": "沒有變更檔案",
    "contextPanel.diffSelectFile": "選擇變更檔案檢視 Diff",
    "chat.loadingSessions": "正在載入會話...",
    "chat.sessions": "會話 · {label}",
    "chat.noMatchingSessions": "未找到匹配的會話",
    "chat.untitledSession": "未命名會話",
    "chat.messagePlaceholderShort": "輸入訊息… (/ 命令)",
    "chat.dropFilesHint": "鬆開以新增到對話",
    "chat.dropFilesDetail": "圖片會作為訊息附件；其他檔案會複製到專案根目錄並插入為 @路徑。",
    "chat.dropNeedsProject": "請先開啟專案，再把檔案拖入對話",
    "chat.dropProjectSuccess": "已新增 {count} 個檔案到專案",
    "chat.dropProjectPartialFailure": "部分檔案未能新增：{detail}",
    "chat.conversationNavigator": "對話定位",
    "chat.ctxUsage": "上下文用量",
    "common.retry": "重試",
    "common.confirmDelete": "確認刪除？",
    "sidebar.tabChats": "會話",
    "sidebar.tabFiles": "檔案",
    "sidebar.viewSwitcher": "側欄檢視",
    "sidebar.projectFiles": "專案檔案",
    "sidebar.noMatchingSessions": "沒有匹配的會話",
    "sidebar.loadFailed": "會話列表載入失敗",
    "sidebar.confirmRemoveWorktree": "刪除這個 worktree checkout？",
    "files.emptyFolder": "空資料夾",
    "files.loadFolderFailed": "無法載入此資料夾",
    "files.dropToUpload": "鬆開以上傳檔案",
    "files.dropToUploadInto": "鬆開以上傳到 {folder}",
    "files.mentionName": "引用 {name}",
    "files.downloadName": "下載 {name}",
    "files.uploadedCount": "{count} 個已上傳",
    "files.skippedCount": "{count} 個已跳過",
    "files.failedCount": "{count} 個失敗",
    "files.choosePreview": "從側欄選擇一個檔案在這裡預覽。",
    "chat.loadFailed": "無法載入該會話",
    "chat.imagesCannotQueue": "Agent 執行時無法排隊傳送圖片附件",
    ...
    "chat.attachmentError": "圖片新增失敗",
    "models.apiKeyStored": "API Key 已儲存。在下方輸入新 Key 可替換，或斷開連線以移除。",
    "models.apiKeyPrompt": "輸入 {name} 的 API Key 以啟用 {count} 個模型。",
    "models.enterNewKey": "輸入新 Key 以替換…",
    "models.modelCount": "{count} 個模型",
    "models.unsavedTitle": "放棄未儲存的更改？",
    "models.unsavedBody": "有尚未儲存的修改，現在關閉將丟失這些更改。",
    "models.keepEditing": "繼續編輯",
    "models.discardChanges": "放棄更改",
    "appshell.untitledTask": "未命名任務",
    "appshell.newTask": "新任務",
    "appshell.subtitle": "本地編碼智慧體",
    "appshell.afterFirstMessage": "傳送第一條訊息後可用",
    "appshell.moreActions": "更多會話操作",
    "appshell.more": "更多",
    "appshell.systemLoads": "傳送第一條訊息後加載",
    "appshell.viewInstructions": "檢視當前系統指令",
    "appshell.toolsDisabled": "工具已停用",
    "appshell.sessionStats": "會話統計",
    "appshell.statsHint": "Token、費用與上下文",
    "updates.available": "有可用更新",
    "updates.dismiss": "關閉更新提醒",
    "updates.remindNextWeek": "下週再提醒我",
    "updates.viewRelease": "檢視釋出",
    "updates.caption": "{product} 每週檢查一次官方 GitHub 釋出。請在設定中檢視並安裝完整的簽名應用更新。",
    "updates.openSettings": "開啟設定",
    "appSettings.tagline": "{product} 將 pi 編碼智慧體的全部能力封進一個優雅的桌面 App。",
    "appSettings.taglineDetails": "瀏覽會話、即時對話、管理模型與 Skills —— 一切資料都留在你的電腦上。",
    "appSettings.close": "關閉設定",
    "appSettings.updatesSection": "版本與更新",
    "appSettings.repository": "專案地址",
    ...
    "appSettings.openReleases": "開啟 GitHub Releases",
    "appSettings.checkingReleases": "正在檢查 GitHub 釋出…",
    "appSettings.checkFailed": "無法檢查 GitHub 釋出。",
    "appSettings.releaseUnavailable": "無法獲取釋出資訊。",
    "appSettings.noReleases": "暫無釋出",
    "appSettings.upToDate": "當前已是最新版本。",
    "appSettings.updateAvailable": "檢測到新版本。",
    "appSettings.update": "更新",
    "appSettings.preparing": "正在準備更新…",
    "appSettings.downloading": "正在下載…",
    "appSettings.downloadingPercent": "正在下載 {percent}%",
    "appSettings.installing": "正在安裝並重啟…",
    "appSettings.updateNote": "更新將安裝一個完整簽名的 {name} 釋出版本。",
    "appSettings.noSignedBundle": "檢測到元件更新，但包含這些更新的簽名 {name} 安裝包尚未釋出。",
    "appSettings.openRelease": "檢視釋出",
    "appSettings.languageSection": "語言",
    "appSettings.languageHint": "選擇介面顯示語言。",
    "appSettings.appearanceSection": "外觀",
    "appSettings.appearanceHint": "選擇淺色或深色模式，你的選擇會被記住。",
    "appSettings.themeLight": "淺色",
    "appSettings.themeDark": "深色",
    "appSettings.customCss": "自定義樣式表",
    "appSettings.customCssHint": "自定義字型、顏色與尺寸，編輯後重新整理視窗生效。",
    "appSettings.diffViewMode": "Diff 顯示",
    "appSettings.diffViewModeHint": "編輯工具的 diff 在對話中的展示方式。",
    "appSettings.diffViewModeSplit": "並排",
    "appSettings.diffViewModeUnified": "統一",
    "appSettings.customCssOpen": "開啟 custom.css",
    "appSettings.customCssOpening": "正在開啟…",
    "appSettings.customCssOpenError": "無法開啟 custom.css",
    "appSettings.desktopSection": "桌面端",
    "appSettings.desktopHint": "視窗、托盤與通知等桌面行為。",
    "appSettings.closeQuits": "關閉視窗時退出應用",
    "appSettings.closeQuitsHint": "關閉此選項時，關閉視窗會將應用隱藏到選單欄 / 系統托盤。",
    "appSettings.notifyOnComplete": "後臺任務完成時傳送系統通知",
    "appSettings.notifyOnCompleteHint": "視窗失焦時，agent 完成後彈出系統通知。",
    "appSettings.quitApp": "退出 Pi Agent",
    "connection.offline": "與本地 Pi Agent 服務的連線已斷開。",
    "connection.retry": "重新連線",
    "sidebar.revealWorktree": "在訪達中顯示",
    "chat.modelScopeUnauthenticated": "\"{pattern}\" 已設定，但供應商 {providers} 沒有可用的憑證 (尚未登入，或其 API 金鑰解析失敗).",
  },
};
