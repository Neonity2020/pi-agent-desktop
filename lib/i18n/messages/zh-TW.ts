...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "files.htmlRunScripts": "執行腳本",
    "files.htmlScriptsOffTitle": "在隔離沙箱中執行此頁面的腳本。沙箱內無法載入以相對路徑引用的本機檔案（CSS、圖片）。",
    "files.htmlScriptsOnTitle": "腳本正在隔離沙箱中執行。點擊返回靜態預覽（可載入本機 CSS 和圖片）。",
    ...
    "chat.forkFailed": "分叉失敗：{error}",
    "chat.navigateFailed": "無法讓 agent 切換到此分支：{error}",
    ...
    "contextPanel.copied": "已複製",
    "contextPanel.copyFailed": "複製失敗",
