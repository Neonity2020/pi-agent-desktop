...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "files.htmlRunScripts": "运行脚本",
    "files.htmlScriptsOffTitle": "在隔离沙箱中运行此页面的脚本。沙箱里无法加载以相对路径引用的本地文件（CSS、图片）。",
    "files.htmlScriptsOnTitle": "脚本正在隔离沙箱中运行。点击返回静态预览（可加载本地 CSS 和图片）。",
    "files.expandPanel": "展开为全宽面板",
    "files.restorePanelWidth": "恢复面板宽度",
    ...
    "sidebar.rename": "重命名",
    "sidebar.delete": "删除",
    "sidebar.renameFailed": "重命名失败：{error}",
    "sidebar.deleteFailed": "删除失败：{error}",
    ...
    "contextPanel.copied": "已复制",
    "contextPanel.copyFailed": "复制失败",
    ...
    "chat.steerPlaceholder": "Enter 排队后续消息 · Steer 立即打断...",
    ...
    "chat.compactingRetry": "正在压缩…（重试 {attempt}/{max}）",
    "chat.cancelRetry": "取消重试",
    "chat.toolCancelled": "已取消",
    "chat.sessionAutomation": "会话自动化",
    "chat.autoCompaction": "上下文写满时自动压缩",
    "chat.autoRetry": "服务商出错时自动重试",
    "chat.steeringMode": "引导消息投递方式",
    "chat.followUpMode": "后续消息投递方式",
    "chat.queueMode.all": "全部投递",
    "chat.queueMode.one-at-a-time": "逐条投递",
    "chat.compact": "压缩",
    "chat.ctxUsage": "上下文用量",
    ...
    "appshell.sessionStats": "会话统计",
    "appshell.statsHint": "Token、费用与上下文",
