...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "sidebar.archivedProjects": "Archived",
    ...
    "chat.dropProjectSuccess": "Added {count} file(s) to the project",
    ...
    "sidebar.noMatchingFiles": "No files match your search",
    ...
    "chat.emptyTitle": "Start a task",
    "chat.emptySubtitle": "{product} can explore, edit, and run this project with you.",
