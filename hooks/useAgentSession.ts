...
export function useAgentSession(opts: UseAgentSessionOptions) {
  ...
  }, [setToolPresetState, seedStreamingSnapshot]);
  ...
  return {
    ...
    agentRunning, modelNames, modelList, modelError, modelScopeWarnings: visibleModelScopeWarnings, dismissModelScopeWarnings, modelThinkingLevels, modelThinkingLevelMaps, newSessionModel, toolPreset, thinkingLevel,
    retryInfo, contextUsage, systemPrompt, forkingEntryId, retryLoad,
